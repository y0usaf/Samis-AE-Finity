...
import com.samiyuru.samiaeinfinity.misc.DecompressionPattern;

import io.netty.buffer.ByteBuf;

public final class InfinityComponents {
    public static final DeferredRegister<DataComponentType<?>> DR =
            DeferredRegister.create(Registries.DATA_COMPONENT_TYPE, SamiAEInfinity.MODID);

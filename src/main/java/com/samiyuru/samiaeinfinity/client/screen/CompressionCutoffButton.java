package com.samiyuru.samiaeinfinity.client.screen;
...
import com.samiyuru.samiaeinfinity.definition.InfinityTranslations;
...
public class CompressionCutoffButton extends IconButton {
    ...
    public List<Component> getTooltipMessage() {
        ...
        message.add(InfinityTranslations.CompressionCutoff.text());

...
public class CompressionService {
    ...
    private static boolean overrideRecipe(CraftingRecipe recipe, List<Override> overrides, RegistryAccess access) {
        ...
        // TODO: Implement compression override system for our mod if needed
        // For now, we'll comment out the data map reference since we don't have MEGADataMaps
        /*
        for (var input : recipe.getIngredients().getFirst().getItems()) {
    ...
    private static boolean isBlacklisted(ItemStack stack) {
        // TODO: Implement blacklist system for our mod if needed
        // For now, we'll return false since we don't have the data map system
